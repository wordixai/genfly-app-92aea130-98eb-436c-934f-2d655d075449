...
const Index = () => {
  const menuItems = [
    ...
    },
    {
      ...
      icon: <Croissant className="w-8 h-8 text-amber-900" />
    },
    {
      name: "Gourmet Sandwiches",
      description: "Made with locally-sourced meats and produce",
      icon: <Sandwich className="w-8 h-8 text-amber-900" />
    }
  ]
  ...
  return (
    <div className="min-h-screen bg-stone-50">
      {/* Hero Section */}
      <section className="relative h-[80vh] bg-stone-800 text-white">
        ...
        <div className="container h-full flex flex-col justify-center relative z-20">
          ...
          <div className="flex gap-4">
            <button className="px-6 py-3 bg-amber-700 hover:bg-amber-800 rounded-lg font-medium">
              View Menu
            </button>
      ...
      <section className="py-20 bg-stone-100">
        <div className="container grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-stone-300 h-96 rounded-xl"></div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-stone-300">Beanville, CA 90210</p>
            </div>
            <div>
              <h3 className="text-xl font-bold mb-4">Hours</h3>
              <p className="text-stone-300">Mon-Fri: 7am - 7pm</p>
              <p className="text-stone-300">Sat-Sun: 8am - 5pm</p>
            </div>
            <div>
              <h3 className="text-xl font-bold mb-4">Connect</h3>
              <p className="text-stone-300">hello@brewandbites.com</p>
